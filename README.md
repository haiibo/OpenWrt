...
- releases中的直刷固件分为[***精简版***](https://github.com/hhaibo/ARMv8-OpenWrt/releases/tag/ARMv8_MINI) 和[***高大全版***](https://github.com/hhaibo/ARMv8-OpenWrt/releases/tag/ARMv8_PLUS)，精简版主要适合科学上网为主要需求的用户，高大全版是正常多插件版本集成各种常用插件。
