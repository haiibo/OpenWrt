...
# 更改 Argon 主题背景
cp -f $GITHUB_WORKSPACE/images/SHINKU_AS_e14a1.png package/luci-theme-argon/htdocs/luci-static/argon/img/SHINKU_AS_e14a1.png
...
sed -i "s/${orig_version}/R${date_version} by wind_mask/g" package/lean/default-settings/files/zzz-default-settings
