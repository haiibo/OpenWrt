...
git_sparse_clone main https://github.com/kenzok8/small-package lluci-app-advanced luci-app-fileassistant luci-app-netspeedtest luci-app-quickstart quickstart 
