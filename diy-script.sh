...
# sed -i 's/https/http/g' package/luci-app-passwall/luci-app-passwall/luasrc/view/passwall/global/status.htm
# sed -i 's/https/http/g' package/luci-app-passwall2/luci-app-passwall2/luasrc/view/passwall2/global/status.htm
