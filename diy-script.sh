...
# 端口初始化
cp -f $GITHUB_WORKSPACE/scripts/99-default_network.txt package/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
...
# 更改 Argon 主题背景
cp -f $GITHUB_WORKSPACE/images/bg4.jpg package/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
...
sed -i "s/${orig_version}/R${date_version} by XuJiuChuan/g" package/lean/default-settings/files/zzz-default-settings
