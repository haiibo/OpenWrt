...
git_sparse_clone main https://github.com/kenzok8/small-package luci-app-advanced luci-app-fileassistant luci-app-netspeedtest luci-app-quickstart quickstart 
